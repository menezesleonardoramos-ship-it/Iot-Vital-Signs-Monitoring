...
// ================= MAX30205 (TEMPERATURA – ÚNICO TRECHO ALTERADO) =================
...
void setup() {
  ...
  // CONFIGURAÇÃO MAX30102 (NÃO MEXER)
...
// =============================================================
// TEMPERATURA COM OVERSAMPLING + FILTRO (ÚNICA LÓGICA NOVA)
float readMAX30205() {
  const int samples = 8;
  float soma = 0;
  int valid = 0;
  ...
  return temperatura * 0.8 + media * 0.2;
}
